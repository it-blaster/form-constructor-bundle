...
namespace Fenrizbes\FormConstructorBundle\Form\Type\FcFormTemplate\Admin;
...
class TemplateCommonType extends AbstractType
{
    protected $action;
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            ...
            'data_class'         => 'Fenrizbes\FormConstructorBundle\Propel\Model\Form\FcFormTemplate'
        ));
    }
