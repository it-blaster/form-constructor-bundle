...
abstract class BaseFcFormBehaviorCondition extends BaseObject implements Persistent, EventDispatcherAwareModelInterface
{
    /**
     * Peer class name
     */
    const PEER = 'Fenrizbes\\FormConstructorBundle\\Propel\\Model\\Behavior\\FcFormBehaviorConditionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FcFormBehaviorConditionPeer
     */
    ...
    /**
     * Initializes internal state of BaseFcFormBehaviorCondition object.
     * @see        applyDefaults()
     */
     ...
     * @return FcFormBehaviorCondition The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = FcFormBehaviorConditionPeer::ID;
        }
    ...
    public function setBehaviorId($v)
    {
        ...
        if ($this->behavior_id !== $v) {
            $this->behavior_id = $v;
            $this->modifiedColumns[] = FcFormBehaviorConditionPeer::BEHAVIOR_ID;
        }
    ...
    public function setCondition($v)
    {
        ...
        if ($this->condition !== $v) {
            $this->condition = $v;
            $this->modifiedColumns[] = FcFormBehaviorConditionPeer::CONDITION;
        }
    ...
    public function setParams($v)
    {
        if ($this->params_unserialized !== $v) {
            ...
            $this->modifiedColumns[] = FcFormBehaviorConditionPeer::PARAMS;
        }
    ...
    /**
     * Sets the value of the [operator] column.
    ...
    public function setOperator($v)
    {
        ...
        if ($this->operator !== $v) {
            $this->operator = $v;
            $this->modifiedColumns[] = FcFormBehaviorConditionPeer::OPERATOR;
        }
    ...
    public function setIsActive($v)
    {
        ...
        if ($this->is_active !== $v) {
            $this->is_active = $v;
            $this->modifiedColumns[] = FcFormBehaviorConditionPeer::IS_ACTIVE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FcFormBehaviorConditionPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FcFormBehaviorConditionPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->condition = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->params = $row[$startcol + 3];
            $this->operator = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
            ...
            return $startcol + 8; // 8 = FcFormBehaviorConditionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FcFormBehaviorCondition object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FcFormBehaviorConditionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FcFormBehaviorConditionQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(FcFormBehaviorConditionPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(FcFormBehaviorConditionPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(FcFormBehaviorConditionPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event_dispatcher behavior
            ...
            if ($ret) {
                ...
                FcFormBehaviorConditionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::BEHAVIOR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`behavior_id`';
        }
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::CONDITION)) {
            $modifiedColumns[':p' . $index++]  = '`condition`';
        }
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::PARAMS)) {
            $modifiedColumns[':p' . $index++]  = '`params`';
        }
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::OPERATOR)) {
            $modifiedColumns[':p' . $index++]  = '`operator`';
        }
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::IS_ACTIVE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `fc_form_behavior_condition` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`params`':
                        ...
                        break;
                    case '`operator`':
                        $stmt->bindValue($identifier, (int) $this->operator, PDO::PARAM_INT);
                        break;
                    case '`is_active`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FcFormBehaviorConditionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FcFormBehaviorConditionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FcFormBehaviorCondition'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FcFormBehaviorCondition'][$this->getPrimaryKey()] = true;
        $keys = FcFormBehaviorConditionPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getBehaviorId(),
            $keys[2] => $this->getCondition(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setCondition($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::ID)) $criteria->add(FcFormBehaviorConditionPeer::ID, $this->id);
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::BEHAVIOR_ID)) $criteria->add(FcFormBehaviorConditionPeer::BEHAVIOR_ID, $this->behavior_id);
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::CONDITION)) $criteria->add(FcFormBehaviorConditionPeer::CONDITION, $this->condition);
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::PARAMS)) $criteria->add(FcFormBehaviorConditionPeer::PARAMS, $this->params);
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::OPERATOR)) $criteria->add(FcFormBehaviorConditionPeer::OPERATOR, $this->operator);
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::IS_ACTIVE)) $criteria->add(FcFormBehaviorConditionPeer::IS_ACTIVE, $this->is_active);
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::CREATED_AT)) $criteria->add(FcFormBehaviorConditionPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(FcFormBehaviorConditionPeer::UPDATED_AT)) $criteria->add(FcFormBehaviorConditionPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(FcFormBehaviorConditionPeer::DATABASE_NAME);
        $criteria->add(FcFormBehaviorConditionPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of FcFormBehaviorCondition (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FcFormBehaviorCondition Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FcFormBehaviorConditionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FcFormBehaviorConditionPeer();
        }
    ...
    public function setFcFormBehavior(FcFormBehavior $v = null)
    {
        ...
        if ($v !== null) {
            $v->addFcFormBehaviorCondition($this);
        }
    ...
    public function getFcFormBehavior(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFcFormBehavior === null && ($this->behavior_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFcFormBehavior->addFcFormBehaviorConditions($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(FcFormBehaviorConditionPeer::DEFAULT_STRING_FORMAT);
    }
